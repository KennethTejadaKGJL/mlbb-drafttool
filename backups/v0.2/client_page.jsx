              ...
              {isAdmin && (
                <div className="flex gap-2 h-full">
                  ...
                  {gameState.started && isMyTurn && gameState.tempHover && (
                    <button onClick={handleLockIn} className="h-full px-6 bg-yellow-400 hover:bg-yellow-300 text-black text-[12px] font-black rounded-md uppercase transition-all shadow-[0_0_20px_rgba(250,204,21,0.6)] animate-pulse">LOCK IN</button>
                  )}
